...
global.owner = ['5511985598458'] // Put your number here
global.mods = ['5511985598458'] // Want some help?
global.prems = ['5511985598458'] // Premium user has unlimited limit
...
conn.welcome = 'OLA@user!\nSEJA BRM VINDO AO GRUPO @subject'
conn.bye = 'FLW MANO ATE... @user!'
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Este comando só pode ser usado por _ *DONO*',
    owner: 'Este comando só pode ser usado por _ *Proprietario do Bot*',
    mods: 'Este comando só pode ser usado por _ * Moderador * _!',
    premium: 'Este comando é apenas para membros _ * Premium * _! ',
    group: 'Este comando só pode ser usado em grupos!',
    private: 'Este comando só pode ser usado em Chats Privados! ',
    admin: 'Este comando é apenas para o grupo * Admin *! ',
    botAdmin: 'Torne o bot um * Admin * para usar este comando!',
    unreg: 'Registre-se para usar este recurso digitando:\n\n*# lista de nomes. Idade*\n\nExemplo: *# Lista humana. 16*'
  }[type]
...
if (!global.support.ffmpeg) conn.logger.warn('Instale o ffmpeg para enviar videos (pkg install ffmpeg)')
if (!global.support.ffmpegWebp) conn.logger.warn('Os adesivos n?o podem ser animados sem libwebp no ffmpeg (--emable-ibwebp while compiling ffmpeg)')
if (!global.support.convert) conn.logger.warn('Os adesivos podem n?o funcionar sem o imagemagick se o libwebp no ffmpeg n?o estiver instalado (pkg install imagemagick)')
